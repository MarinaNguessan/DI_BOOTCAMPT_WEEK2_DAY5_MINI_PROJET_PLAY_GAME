 ...
 *                 en suite compare le nombre entré a un nombre aleatoire que l'ordinateur fournir)
...
function playTheGame() {
    // Demandons à l'utilisateur s'il souhaite jouer au jeu
...
//2. Si sa réponse est vraie, suivez ces étapes :
    //1. Demandons à l'utilisateur d'entrer un nombre entre 0 et 10
    let userNumber;
    while (true) {
